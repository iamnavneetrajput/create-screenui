...
function App() {
  return (
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen 
      ...
      <main className="flex flex-col gap-10 row-start-2 items-center sm:items-start text-center sm:text-left">
        ...
        <div className="flex flex-col gap-3">
          <h1 className="text-2xl sm:text-3xl font-bold">
            Welcome to your{" "}
            <span className="text-[hsl(var(--primary))]">ScreenUI</span> App 🚀
          </h1>
          <p className="text-[hsl(var(--muted-foreground))] max-w-md">
            This is a <strong>Vite + React + Tailwind</strong> project
        ...
        <ol className="list-inside list-decimal text-sm font-mono leading-6 text-[hsl(var(--foreground))]">
          <li className="mb-2 tracking-[-.01em]">
            Open{" "}
            <code className="bg-[hsl(var(--muted))] text-[hsl(var(--foreground))] px-1 py-0.5 rounded font-semibold">
              src/App.jsx
            </code>{" "}
        ...
        <div className="flex gap-4 items-center flex-col sm:flex-row">
          <a
            className="rounded-full transition-colors flex items-center justify-center 
              ...
              gap-2 hover:opacity-90 font-medium text-sm sm:text-base 
              h-10 sm:h-12 px-5 sm:w-auto"
            href="https://screenui.com/library"
            target="_blank"
            rel="noopener noreferrer"
          >
          ...
          <a
            className="rounded-full border border-[hsl(var(--border))] transition-colors flex items-center justify-center 
              hover:bg-[hsl(var(--muted))] hover:text-[hsl(var(--foreground))] 
              font-medium text-sm sm:text-base h-10 sm:h-12 px-5 
      ...
      {/* Footer */}
      <footer className="row-start-3 flex gap-6 flex-wrap items-center justify-center text-sm text-[hsl(var(--muted-foreground))]">
        <a
